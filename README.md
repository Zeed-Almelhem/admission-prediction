...
To view the HTML output of the project and the associated notebook, please visit [the project's page on my website](https://www.zeed-almelhem.com/house-price-predictions). Alternatively, you can [click here](https://github.com/Zeed-Almelhem/admission-prediction/blob/main/Addmision_Prediction.ipynb) to access the code on GitHub.
